...
if ( ! function_exists( 'ot_display_by_type' ) ) {
  ...
  function ot_display_by_type( $args = array() ) {
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo '<p>' . sprintf( 'Sorry, this function does not exist') . '</p>';
    }
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<div class="ot-background-group">';
          ...
          if ( in_array( 'background-color', $ot_recognized_background_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Color', 'option-tree'));
          ...
          if ( in_array( 'background-repeat', $ot_recognized_background_fields ) ) {
            ...
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Repeat', 'option-tree'));
          ...
          if ( in_array( 'background-attachment', $ot_recognized_background_fields ) ) {
            ...
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Attachment', 'option-tree'));
          ...
          if ( in_array( 'background-position', $ot_recognized_background_fields ) ) {
            ...
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Position', 'option-tree'));
          ...
          if ( in_array( 'background-size', $ot_recognized_background_fields ) ) {
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
                printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Size', 'option-tree'));
              /* build select */
              ...
              echo '</div>';
                ...
                printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Size', 'option-tree'));
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" />';
                echo '</div>';
        ...
        if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Background Image', 'option-tree'));
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* add media button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'option-tree' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add Media', 'option-tree' ) . '</a>';

	        if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
		        /* remove media button */
		        echo '<a href="javascript:(void);" class="ot_remove_media option-tree-ui-remove-media option-tree-ui-button button-secondary light" title="' . __( 'Remove Media', 'option-tree' ) . '"><span class="icon ot-icon-minus-circle"></span>' . __( 'Remove Media', 'option-tree' ) . '</a>';
	        }
    ...
    echo '<div class="format-setting type-box-shadow ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'offset-x', $ot_recognized_box_shadow_fields ) ) {
          ...
          $offset_x = isset( $field_value['offset-x'] ) ? esc_attr( $field_value['offset-x'] ) : '0';
          echo '<div class="field-label-wrapper ot-option-group--one-fifth"><span>'.__('Offset Left', 'option-tree').'</span>';
          echo '<div class="ot-option-group ot-option-group--full"><span class="ot-icon-arrows-h ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[offset-x]" id="' . esc_attr( $field_id ) . '-offset-x" value="' . $offset_x . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" /><span class="ot-option-group--icon-right">px</span></div></div>';
        ...
        if ( in_array( 'offset-y', $ot_recognized_box_shadow_fields ) ) {
          ...
          $offset_y = isset( $field_value['offset-y'] ) ? esc_attr( $field_value['offset-y'] ) : '0';
	        echo '<div class="field-label-wrapper ot-option-group--one-fifth"><span>'.__('Offset Top', 'option-tree').'</span>';
            echo '<div class="ot-option-group ot-option-group--full"><span class="ot-icon-arrows-v ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[offset-y]" id="' . esc_attr( $field_id ) . '-offset-y" value="' . $offset_y . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" /><span class="ot-option-group--icon-right">px</span></div>';
            echo '</div>';
        ...
        if ( in_array( 'blur-radius', $ot_recognized_box_shadow_fields ) ) {
          ...
          $blur_radius = isset( $field_value['blur-radius'] ) ? esc_attr( $field_value['blur-radius'] ) : '0';
	        echo '<div class="field-label-wrapper ot-option-group--one-fifth"><span>Blur Radius</span>';
          echo '<div class="ot-option-group ot-option-group--full"><span class="ot-icon-circle ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[blur-radius]" id="' . esc_attr( $field_id ) . '-blur-radius" value="' . $blur_radius . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" /><span class="ot-option-group--icon-right">px</span></div>';
          echo '</div>';
        ...
        if ( in_array( 'spread-radius', $ot_recognized_box_shadow_fields ) ) {
          ...
          $spread_radius = isset( $field_value['spread-radius'] ) ? esc_attr( $field_value['spread-radius'] ) : '0';
	        echo '<div class="field-label-wrapper ot-option-group--one-fifth"><span>Spread</span>';
          echo '<div class="ot-option-group ot-option-group--full"><span class="ot-icon-arrows-alt ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[spread-radius]" id="' . esc_attr( $field_id ) . '-spread-radius" value="' . $spread_radius . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" /><span class="ot-option-group--icon-right">px</span></div>';
          echo '</div>';
        ...
        if ( in_array( 'color', $ot_recognized_box_shadow_fields ) ) {
	        echo '<div class="field-label-wrapper ot-option-group--one-fifth"><span>Color</span>';
          echo '<div class="option-tree-ui-colorpicker-input-wrap">';
            ...
            /* set color */
            $color = isset( $field_value['color'] ) ? esc_attr( $field_value['color'] ) : '#cccccc';
  ...
  function ot_type_custom_post_type_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'ot_type_custom_post_type_checkbox_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'date', 'order' => 'DESC', 'post_status' => 'any' ), $field_id ) );
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          foreach( $ids as $id ) {
            ...
            echo '<li style="background-image:url('.$thumbnail[0].')"><img  src="' . $thumbnail[0] . '" width="75" height="75" /></li>';
...
if ( ! function_exists( 'ot_type_google_fonts' ) ) {
    ...
    function ot_type_google_fonts( $args = array() ) {
        ...
        echo '<a href="javascript:void(0);" class="js-add-google-font option-tree-ui-button button button-primary left hug-left" title="' . __( 'Add Google Font', 'option-tree' ) . '">' . __( 'Add Google Font', 'option-tree' ) . '</a>';
...
if ( ! function_exists( 'ot_type_link_color' ) ) {
  ...
  function ot_type_link_color( $args = array() ) {
    ...
    /* Opacity option added for link color fields. */
    $args['field_class'] = isset( $args['field_class'] ) ? $args['field_class'] . ' ot-colorpicker-opacity' : 'ot-colorpicker-opacity';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'ot_type_textarea_lite' ) ) {

  function ot_type_textarea_lite( $args = array() ) {
    ...
    /* format setting outer wrapper */
    echo '<div class="format-setting type-textarea lite ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . ' fill-area">';
      ...
      $editor_args = array(
          ...
          /*'tinymce'       => apply_filters( 'ot_tinymce', true, $field_id ),*/
          'tinymce'       => true,
          'quicktags'     => apply_filters( 'ot_quicktags', array( 'buttons' => 'strong,em,link,ins,img,ul,ol,li,code' ), $field_id )
      );

      #var_dump(apply_filters( 'ot_quicktags', array( 'buttons' => 'strong,em,link,del,ins,img,ul,ol,li,code,spell,close' ), $field_id ));


        if(isset($field_class) && (strpos($field_class, 'media')!== false))
            $editor_args['media_buttons'] = true;
 ...
 * @since     2.0
 */
if ( ! function_exists( 'ot_type_textblock_block' ) ) {

    function ot_type_textblock_block( $args = array() ) {

        /* turns arguments array into variables */
        extract( $args );

        /* format setting outer wrapper */
        echo '<div class="format-setting display_block type-textblock titled wide-desc">';
...
if ( ! function_exists( 'ot_type_typography' ) ) {
    ...
    function ot_type_typography( $args = array() ) {
        ...
        if ( in_array( 'font-family', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Font Family', 'option-tree'));
        ...
        if ( in_array( 'font-size', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Font Size', 'option-tree'));
        ...
        if ( in_array( 'font-style', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Font Style', 'option-tree'));
        ...
        if ( in_array( 'font-variant', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Font Variant', 'option-tree'));
        ...
        if ( in_array( 'font-weight', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Font Weight', 'option-tree'));
        ...
        if ( in_array( 'letter-spacing', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Letter Spacing', 'option-tree'));
        ...
        if ( in_array( 'line-height', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Line Height', 'option-tree'));
        ...
        if ( in_array( 'text-decoration', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Text Decoration', 'option-tree'));
        ...
        if ( in_array( 'text-transform', $ot_recognized_typography_fields ) ) {
            printf('<div class="field-label-wrapper"><span>%s</span>', __('Text Transform', 'option-tree'));
    ...
    echo '<div class="format-setting type-upload ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<div class="option-tree-ui-upload-parent">';
          ...
          /* input */
          echo '<input type="text" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" value="' . esc_attr( $field_value ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="'.__('Select an image by clicking the + button', 'option-tree').'" />';
		  ...
		  if ( $field_value ) {
			  echo '<a href="javascript:(void);" class="ot_remove_media option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'option-tree' ) . '"><span class="icon ot-icon-minus-circle"></span>' . __( 'Remove Media', 'option-tree' ) . '</a>';
		  }
...
/**
 * "one.com One-Click Demo Data Importer" option type.
 */
if ( ! function_exists( 'onecom_importer' ) ) {

    function ot_type_onecom_importer( $args = array() ) {
        /* turns arguments array into variables */
