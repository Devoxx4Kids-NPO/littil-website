...
if ( ! defined( 'ONECOM_WP_VERSION' ) ) {
    define( 'ONECOM_WP_VERSION', '2.0.16' );
}
...
if ( ! defined( 'OC_CP_LOGIN_URL' ) ) {
    define( 'OC_CP_LOGIN_URL', sprintf("https://one.com/admin/select-admin-domain.do?domain=%s&targetUrl=/admin/managedwp/%s/managed-wp-dashboard.do", $_SERVER['ONECOM_DOMAIN_NAME'], $_SERVER['HTTP_HOST']) );
}
...
/**
 * Include centralised menu
 **/

if (!class_exists('OneComCentralizedMenu') && file_exists(ONECOM_WP_PATH . 'inc' . DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR . 'class-onecom-centralized-menu.php')) {
    require_once (ONECOM_WP_PATH . 'inc' . DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR . 'class-onecom-centralized-menu.php');
    new OneComCentralizedMenu();
}
