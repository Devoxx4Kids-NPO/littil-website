<div class="wrap" id="onecom-ui">
    ...
    <h1 class="one-title"> <?php echo __("Cookie Banner", "onecom-wp"); ?> </h1>
    <div class="page-subtitle">
        <?php _e('Show a banner on your website to inform visitors about cookies and get their consent.', "onecom-wp")?>
    </div>
        ...
        <div class="card-left">
            ...
            <form name="oc_cb_config_form" id="oc_cb_config_form">
                ...
                <div class="fieldset cb_fields <?php echo $show; ?>">
                    ...
                    <p class="oc_desc indent"><?php echo __("Your privacy policy can contain information about which cookies you use, so visitors can read more about what you collect information about.", "onecom-wp"); ?> 
    ...
    <div class="card-bottom">
        <div class="text-left">
            <span class="idea_icon"></span><strong><?php echo __("Tip", "onecom-wp");?>: </strong><?php echo __("Remember to delete cache in case you are using any caching plugin.", "onecom-wp"); ?> 
